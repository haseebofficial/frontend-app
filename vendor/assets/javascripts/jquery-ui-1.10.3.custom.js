...
function Datepicker() {
	...
	this.regional[""] = { // Default regional settings
		...
		monthNamesShort: ["Янв", "Фев", "Мрт", "Апр", "Май", "Июн", "Июл", "Авг", "Сен", "Окт", "Ноя", "Дек"], // For formatting
	...
	this.regional["ru"] = this.regional[""]
	this.regional["en"] = { 
		closeText: "Done", // Display text for close link
	...
	this.regional["de"] = { 
		closeText: "Done", // Display text for close link
		prevText: "Rückwärts", // Display text for previous month link
		nextText: "Vorwärts", // Display text for next month link
		...
		monthNamesShort: ["Jan", "Feb", "Mrz", "Apr", "Mai", "Jun", "Jul", "Aug", "Sep", "Okt", "Nov", "Dez"], // For formatting
		...
		weekHeader: "Woche", // Column header for week of the year
		dateFormat: "mm/dd/yy", // See format options on parseDate
		firstDay: 0, // The first day of the week, Sun = 0, Mon = 1, ...
		isRTL: false, // True if right-to-left language, false if left-to-right
		showMonthAfterYear: false, // True if the year select precedes month, false for month then year
	...
	this.regional["fr"] = { 
		...
		monthNamesShort: ['Janv', 'Févr', 'Mars', 'Avri', 'Mai', 'Juin', 'Juil', 'Août', 'Sept', 'Oct', 'Nov', 'Déc'], // For formatting
	...
	this.regional["zh"] = { 
		...
		dayNames: ["週日", "週一", "週二", "週三", "週四", "週五", "週六"], // For formatting
		dayNamesShort: ["週日", "週一", "週二", "週三", "週四", "週五", "週六"], // For formatting
		dayNamesMin: ["週日", "週一", "週二", "週三", "週四", "週五", "週六"], // Column headings for days starting at Sunday
		weekHeader: "Wk", // Column header for week of the year
		isRTL: false, // True if right-to-left language, false if left-to-right
	...
	this.regional["it"] = { 
		...
		nextText: "Next", // Display text for next month link
		currentText: "Today", // Display text for current month link
		monthNames: ["Gennai,", "Febbraio", "Marzo", "Aprile", "Maggio", "Giugno", "Luglio", "Agosto", "Settembre", "Ottobre", "Novembre", "Dicembre"], // Names of months for drop-down and formatting
		monthNamesShort: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], // For formatting
		dayNames: ["Domenica", "Lunedì", "Martedì", "Mercoledì", "Giovedì", "Venerdì", "Sabato"], // For formatting
		dayNamesShort: ['Do', 'Lun', 'Mar', 'Mer', 'Gio', 'Ven', 'Sab'], // For formatting
		dayNamesMin: ['Do', 'Lun', 'Mar', 'Mer', 'Gio', 'Ven', 'Sab'], // Column headings for days starting at Sunday
		weekHeader: "Wk", // Column header for week of the year
		isRTL: false, // True if right-to-left language, false if left-to-right
		showMonthAfterYear: false, // True if the year select precedes month, false for month then year
		yearSuffix: "" // Additional text to append to the year in the month headers
	...
	this.regional["ja"] = { 
		...
		dayNamesShort: ["日曜日", "月曜日", "火曜日", "水曜日", "木曜日", "金曜日", "土曜日"], // For formatting
